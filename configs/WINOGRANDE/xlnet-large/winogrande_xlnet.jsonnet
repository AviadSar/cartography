...
local MODEL_TYPE = "xlnet_mc";
local DATA_DIR = "C:\\my_documents\\datasets\\WINOGRANDE_TSV";
local FEATURES_CACHE_DIR = DATA_DIR + "\\cache_" + MODEL_TYPE + "_" + SEED ;
