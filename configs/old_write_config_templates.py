...
#                    eval_tasks_names=['hellaswag', 'abductive_nli', 'WINOGRANDE'], num_eval_cycles='1', eval_samples='128')
#
# quick_write_config(workspace='huji', task='SNLI', model='microsoft/deberta-large',
#                    model_type='deberta', model_name='deberta-large', eval_tasks_names=['anli_v1.0_R3', 'SNLI'],
#                    time='time=4:0:0', num_eval_cycles='1', eval_samples='128', seed='47')
