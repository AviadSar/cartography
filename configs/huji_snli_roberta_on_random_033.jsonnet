...
local TASK = "SNLI";
local DATA_DIR = "/cs/labs/roys/aviadsa/cartography/cartography/filtered_datasets/cartography_random_0.33/SNLI/huji_snli_5_bert";
local FEATURES_CACHE_DIR = "/cs/labs/roys/aviadsa/datasets/swabhas/data/glue/" + TASK + "/cache_roberta_on_random_033_" + SEED;
