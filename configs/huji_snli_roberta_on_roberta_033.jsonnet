...
local TASK = "SNLI";
local DATA_DIR = "/cs/labs/roys/aviadsa/cartography/cartography/filtered_datasets/cartography_variability_0.33/SNLI/huji_snli_5_roberta";
local FEATURES_CACHE_DIR = "/cs/labs/roys/aviadsa/datasets/swabhas/data/glue/" + TASK + "/cache_roberta_on_roberta_033_" + SEED;
